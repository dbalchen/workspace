...
<body>
	...
	<h3>
		...
		<html:form method="post" action="/ChangePasswordAction.do"
			...
			<table border="0">
				...
				<tr>
					<td>Old Password</td>
					<td><html:password property="old_password" /> <em><font
							size="-2">(required)</font></em></td>
				</tr>
				<tr>
					<td>New Password</td>
					<td><html:password property="new_password" /> <em><font
							size="-2">(required)</font></em></td>
				</tr>
				<tr>
					<td>Confirm New Password</td>
					<td><html:password property="confirm_new_password" /> <em><font
							size="-2">(required)</font></em></td>
				</tr>
			</table>
			<p>
