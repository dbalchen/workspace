...
public class LogWriter {
    ...
    public static final String LASTMODIFIEDDATE = "$Date:   10 Jun 2004 20:42:30  $";
    public static final String LASTMODIFIEDVERSION = "$Revision:   1.0.5.1  $";
    ...
    private String GetTimeStamp() {
        ...
        timestring = Utils.PadStringBefore(
