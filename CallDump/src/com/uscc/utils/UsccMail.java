 ...
 *
 *      try {
 *          UsccMail.sendMessage(smtpHost, from, to, subject, text);
 *
 ...
 *
 *      try {
 *            UsccMail.sendMessageAttach(smtpHost, from, to, subject, text, fileNamesList);
...
public class UsccMail {
	 ...
	 *  @param fileNameList the names of the files to attach. Each file name is the complete filesystem path of the file to attach 
     *  (ie c:\dev\demoapp\website\pubs\atari.pdf).  If you are developing a servlet/JSP then see the usage example 
	 ...
	 *  @param subject subject of the e-mail message
	 *  @param messageText the text of the message
	 *  @param fileNameList the names of the files to attach. Each file name is the complete filesystem path 
     *  of the file to attach (ie c:\dev\demoapp\website\pubs\atari.pdf).  If you are developing a servlet/JSP 
     *  then see the usage example at the beginning of this file.
	 *
	 *  @throws javax.mail.MessagingFormatException problems sending message
	 */
	public static void sendMessageAttach(
	...
	public static void sendMessageAttach(
        ...
        public static void main(String args[]) {
           try {
           UsccMail.sendMessage("fortress-2.uscc.com","craig.stalsberg@uscellular.com","craig.stalsberg@uscellular.com","test","test");
           } catch (Exception ie) {}
        }
}
