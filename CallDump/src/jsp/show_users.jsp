...
<body>
	...
	<table align="center" bordercolor="black" border="2" cellpadding="5"
		...
		<tr bgcolor="#000066">
			...
			<th><FONT COLOR="white" FACE="century" SIZE="2">Email
					Address</th>
		...
		<jstl-core:forEach var="userlist" items="${userskey}">
			<tr bgcolor="${userlist.util}">
				...
				<td><FONT FACE="century" SIZE="2"><html:link
							page="/security/ChangeUserStatus.do?id=${userlist.userId}&status=${userlist.status}"
							target="_self">Change</html:link></font></td>
				<td><FONT FACE="century" SIZE="2"><html:link
							page="/security/ShowUserRoleUpdate.do?user=${userlist.userId}"
							target="_self">Edit</html:link></font></td>
			</tr>
		</jstl-core:forEach>
	</table>
