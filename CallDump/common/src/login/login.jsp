...
<TABLE BGCOLOR="LIGHTBLUE" WIDTH=428 CELLSPACING=0 CELLPADDING=5 BORDER=0>
<br>
<br>
<br>
<br>
...
<form action="j_security_check" method="POST">
	<tr>
		...
		<FONT FACE="Helvetica, Arial" SIZE="6"><b>
			Login
		</b><font>
		</td>
	</tr>
	...
	<tr>
		<td align="right"><FONT FACE="Helvetica, Arial" size="3"><b>User ID</b></font></td>
	...
	<tr>
                <td colspan="2" align="center"><html:link page="/showPasswordReminderForm.do" target="_blank">Forgot Password</html:link></font><br></td>
	</tr>
