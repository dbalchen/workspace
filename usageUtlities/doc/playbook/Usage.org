...
*** Purpose of this document
    - The purpose of this document is to describe the Credit Decisioning process, including a high level description of the data flow, potential points of failure, automated monitoring and alerts, and mitigation and failover plans.
...
*** Impacted Systems
    ...
    | NDC (Mediation)    | Converts the raw switch records to the UFF format sends all files to the CallDump, sends the billable records to *TOPS* | Upstream   |
...
|-------------------------------------------------------------------+----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------|
| What’s Monitored?                                                 | Who’s Notified?                                    | What’s Validated?                                                                                                            | What’s Next?                                                 |
|-------------------------------------------------------------------+----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------|
| All usage is tracked through the entire system/sub-system of TOPS | Is Billing Operations On Call associate and leader | Follow instruction in on call document to validate that all files are processed . Engage Amdocs and internal SME as needed . | The Process Owner will initiate an Incident Bridge if needed |
|-------------------------------------------------------------------+----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------|
...
*** External Contacts
   ...
   - Amdocs
     - Serhiy (APRM)
     - Amit Droer (Turbo Charging)
     - Satish (Everything else)cd 
*** Reference Data
