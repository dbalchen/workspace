...
** Phases Legend
  ...
  - (a) Help find usage for this number
  - (b) Where is the money?
  - (c) Help find this roaming usage
  - (d) What's wrong with the bill?
  - (e) Call Detail Records (UFF)
  - (f) Rated usage
  - (g) The raw switch records
  - (h) Check Data Issues
  - (i) Check post-paid usage file processing
  - (j) Post and Pre-Pay rating
  - (k) Roaming file and rating
  - (l) Pre-Pay connection issues
  - (m) Rating errors
  - (n) file errors
  - (o) roaming errors
  - (p) UFF creation and file transfer
  - (q) Incorrect rate
  - (r) missing usage

** TODO Usage Playbook
*** Usage Issue Flow Chart

digraph BI {
"Satish" -> "TOPS"
"Amit Droer" -> "TOPS"
"Serhiy" -> "TOPS"
"Heather Jescke" -> "Revenue Accounting"
"Miquel Jones" -> "Revenue Accounting"
"Ellen Sveinsson" -> "ICS"
"Liz Pierce" -> "ICS"
"Ilham Elgarni" -> "ICS"
"Craig Stalsberg" -> "PDC"
"Yogesh Prasad (Amdocs)" -> "EPC"
"John Schultz" -> "EPC"
"John Samz" -> "EPC"
"David Balchen" -> "Usage"
"David Balchen" -> "CallDump"
"David Balchen" -> "EPS Monitors"
"David Smith" -> "Usage"
"David Smith" -> "FYI Messages"
"Bill Pack" -> "Engineering"
"Christien Bekos" -> "Revenue Assurance"
"Deanna Andrews" -> "Revenue Assurance"
"Shawntrice Moses Butler" -> "Amdocs"
"Ellen Sveinsson" -> "TNS"
"Ilham Elgarni" -> "TNS"
"George Kamba" -> "CallDump"
"Connie Dwyer" -> "Queen"
"Denise Lintz" -> "Supreme Monarch"
"Izabela Miller" -> "CallDump"
"Soly Haddock" -> "CallDump"
"Connie Davis" -> "CallDump"
}

digraph BI {
	graph [splines=true nodesep=0.8  constraint=false overlap=false style=bold];
	node [shape=point]; "";	
	node [shape=plaintext]; "PDC";
	"Usage Inquiry" -> "CallDump"  [label = "(e)"]
	"Usage Inquiry" -> ""  [label = "(f)"]
	"Usage Inquiry" -> "PDC"  [label = "(g)"]
	"Usage Inquiry" -> "Engineering"  [label = "(h)"]
	"" -> "ANF"  [label = "(i)"]
	"" -> "TC"  [label = "(j)"]
	"" -> "ARCM/ARPM"  [label = "(k)"]
	"TC" -> "PDC"  [label = "(l)"]
	"TC" -> "AEM"  [label = "(m)"]
	"ANF" -> "AEM"  [label = "(n)"]
	"ARCM/ARPM" -> "AEM"  [label = "(o)"]
	"CallDump" -> "PDC"  [label = "(p)"]
	"TC" -> "EPC"  [label = "(q)"] 
	"PDC" -> "Engineering"  [label = "(r)"]
	"Revenue\nAssurance" -> "Usage Inquiry"  [label = "(d)"]
	"ICS" -> "Usage Inquiry" [label = "(c)"]
	"Revenue\nAccounting" -> "Usage Inquiry" [label = "(b)"]
	"Subpoena\nTeam" -> "Usage Inquiry" [label = "(a)"]
...
*** Definition of Responsibilities
    ...
    |------------------+------------------------+-------------------------------------------------------------------------------+---------------------------------------------------------------------------|
    | Process Owner    | IS Billing Ops         | First point of contact and technical SME for process issues                   | Join Incident Bridges and use the Playbook as a guide in issue resolution |
    ...
    |                  |                        |                                                                               |                                                                           |
    | Business Partner | Inter-carrier services | This team holds the business relationship between us and our roaming partners | Questions pertaining to our roaming partners                              |
    |                  |                        |                                                                               |                                                                           |
    | Business Partner | Amdocs                 | They own the *TOPS* usage processing stack                                    | Issues involving the usage flow from file to database                     |
    |                  |                        |                                                                               |                                                                           |
    | Business Partner | Revenue Accounting     | APRM charges reconciliation                                                   | Cash differences between APRM and the Clearinghouse                       |
    |                  |                        |                                                                               |                                                                           |
    |                  |                        |                                                                               |                                                                           |
    |------------------+------------------------+-------------------------------------------------------------------------------+---------------------------------------------------------------------------|
...
*** Impacted Systems
    ...
    | Revenue Accounting | Processing late or missing usage will cause the financial’s to be off.                                                       | Downstream |
...
*** Alerting and Monitoring
    Usage has the most complete and thorough monitoring systems within all of *TOPS*, every usage feed and sub-system has an associated report. 
    ...
    In addition the [[https://kpr01scd01.uscc.com:8080/WebMonitor/servlet/WebMonitor?MonName=Dash][EPS Monitors]] provides a dashboard to the entire usage process flow.
...
*** Reference Data
     ...
     [[https://usc.intranet.teldta.com/sites/is/operations/IS_Billing_Ops/Shared%2520Documents/Operational%2520Support%2520Guide%2520-%2520Usage.docx][*Usage Operational Support Guide*]]

     [[https://usc.intranet.teldta.com/sites/is/operations/IS_Billing_Ops/Shared%2520Documents/Usage.pdf][*The Usage Bible*]]
