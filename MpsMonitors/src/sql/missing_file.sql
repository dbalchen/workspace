SELECT aclf.IDENTIFIER, 
       ...
       aclf.STRT_BLOCK,
       MOD(aclf.END_BLOCK,10000) end_block -- when NTI blocks wrap, 1,000,000 is
                                           -- added to the first value after wrap.
...
ORDER BY aclf.FSRC_SENSOR_ID,
      trunc(aclf.RCRDNG_START_DATE), aclf.RCRDNG_END_DATE,
