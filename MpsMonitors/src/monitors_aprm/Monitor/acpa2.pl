...
print '<TABLE CELLPADDING=3 > <TR> <TD ALIGN="CENTER"><B><FONT COLOR="#800040"><a HREF="http://kpr01scdap.uscc.com:8080/WebMonitor/servlet/WebMonitor?MonName=Oncall'.$EnvName.'" target="Oncall'.$EnvName.'">'.$EnvName.'</a></FONT></B></TD> </TR> </TABLE>';
