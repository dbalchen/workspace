...
CREATE CACHED TABLE "REJECTED_RECORDS"("FILE_NAME" VARCHAR(255),"ERROR_CODE" VARCHAR(255),"ERROR_TYPE" VARCHAR(255),"ERROR_DESCRIPTION" VARCHAR(255),"TOTAL_CHARGE" NUMERIC(38,2))
CREATE CACHED TABLE "APRM"("CARRIER_CODE" VARCHAR(255),"MARKET_CODE" VARCHAR(255),"FILE_TYPE" VARCHAR(255),"BP_START_DATE" DATE NOT NULL,"DATE_PROCESSED" DATE,"CLEARINGHOUSE" VARCHAR(255),"RECORD_COUNT" NUMERIC(38),"TOTAL_VOLUME" NUMERIC(38),"TOTAL_CHARGES" NUMERIC(38,2),"USAGE_TYPE" VARCHAR(100),"RECORD_COUNT_DCH" NUMERIC(38),"TOTAL_VOLUME_DCH" NUMERIC(38),"TOTAL_CHARGES_DCH" NUMERIC(38,2),"SERVE_BID" VARCHAR(100))
CREATE CACHED TABLE "DCH_INFO"("USAGE_TYPE" VARCHAR(10),"ROAMING_TYPE" VARCHAR(255),"PROCESS_DATE" DATE,"SETTLEMENT_DATE" DATE,"MY_CARRIER_NAME" VARCHAR(255),"MY_SID" VARCHAR(255),"THEIR_CARRIER_NAME" VARCHAR(255),"THEIR_SID" VARCHAR(255),"SEQUENCE_NUMBER" NUMERIC(5),"FILE_NAME" VARCHAR(255),"CALL_TYPE" VARCHAR(255),"TOTAL_RECORDS" NUMERIC(36),"TOTAL_DURATION" NUMERIC(36),"TOTAL_VOLUME" NUMERIC(36),"TOTAL_CHARGES" NUMERIC(36,2))
