...
*** Project Description
   ...
   to complete other than that no specific deployment date has been given.
    1. API enhancements:
     - Syniverse API is EOL and we will need to enhance our API’s to support the newly upgraded Syniverse API
...
*** status
    - Track 1.1 June test frame
    - Track 1.2 May 25th delivery
    - Engineering/Nokia Android device provisioning specs and MDM solution for E911 Address Collection required are gating 
    completion of the Provisioning Impact Assessment (IA). Provisioning IA remains on hold awaiting Android specs. 
    Discussion underway to track IS development for Acme/iOS and Android separately. Amdocs targeting PI29 and August release 
    for the Acme provisioning. Nokia projecting 4/30 to provide USCC with Android provisioning specs. Non-Provisioning IA and E3 are complete.
    - New project tracks for provisioning:
      1. *1.2a ACME*
      2. *1.2b Android*
    Received the [[https://usc.intranet.teldta.com/sites/EPR/IR0411/Documents/USCC%2520Phase1%2520-%2520A%2520and%2520F%2520-%2520Unified%2520Format%2520-%2520IDD.docx][UFF file format]] changes and I'm reviewing it now.
    - On Track - Overall
    - Launched in August release. TOPS changes will not be live until the controlled launch for Acme (scheduled for December 2019). 
      Will continue reporting status for this track through the warranty period.
    Test calls are being made
    - USCC - AAM - Mobile Device Management Integration- IDD has been updated addressing posted comments.
    - USCC TOPS IA IR0411 CR937 VoWiFi Track 1.2b Android Prepaid VoWIFI has been updated in SharePoint and moved to state 9 - Approval Requested.   
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|
    | Project Track                    | Status   | Comments                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Path to Green/Reason for Status Change                                                                                               |
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|
    | IR0411 VoWiFi - Non-provisioning | ON TRACK | Launched in August release. TOPS changes will not be live until the controlled launch for Acme (scheduled for December 2019). Will continue reporting status for this track through the warranty period.                                                                                                                                                                                                                                                                                                                                                                                                       | N/A                                                                                                                                  |
    | IR0411 VoWiFi - Acme             | ON TRACK | IS/Provisioning: Track 1.2a launched in August release. Engineering: A solution to support MMS (multi-media messaging service) and VVM (visual voice-mail) is being developed and Acme is working with USCC to accommodate additional time for testing. Acme carrier bundle testing for non-MMS, non-VVM test cases will be completed by 9/30 to submit device logs to Acme.                                                                                                                                                                                                                                   | Acme agreed to extend the 9/30 deadline for submitting device logs for MMS/VVM to allow USCC time to develop/test a viable solution. |
    | IR0411 VoWiFi - Android          | ON TRACK | IS/Provisioning: Targeting PI33 with December code drop and January 2020 release. Amdocs delivered IA for CR937, ongoing discussions to assess feasibility and planning considerations for adding prepaid Android development to postpaid Android development. Engineering: USCC/Nokia confirmed latest schedule revision (Dec 2019 lab testing, 03/04/20 production ready, 03/31/20 NRD). Earliest commercial launch date for Samsung (single device) tentatively set at 05/01/20 (working to pull this in if possible). Remaining OEM's are TBD until DEG finalizes requirements for android devices.        | N/A                                                                                                                                  |
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|
    | Project Track                    | Status   | Comments                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Path to Green/Reason for Status Change                                                                                               |
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|
    | IR0411 VoWiFi - Acme             | ON TRACK | A solution to support MMS (multi-media messaging service) and VVM (visual voice-mail) is being developed and Acme is working with USCC to accommodate additional time for testing. Carrier bundle testing for non-MMS, non-VVM, non-911 test cases was completed to send device logs to Acme. Acme agreed to submission of device logs for MMS/VVM test cases by end of October.                                                                                                                                                                                                                               | N/A                                                                                                                                  |
    | IR0411 VoWiFi - Android          | ON TRACK | IS/Provisioning: Targeting PI33 with December code drop and January 2020 release. IA for CR937 approved on 9/26; IS reviewing IA to assess impacts for adding prepaid Android development to postpaid Android development. Engineering: USCC/Nokia tracking to latest schedule revision (Dec 2019 lab testing, 03/04/20 production ready, 03/31/20 NRD). Earliest commercial launch date for Samsung (single device) tentatively set at 05/01/20 (would require approval for parallel testing by Samsung to pull in any further). Other OEM's remain TBD until DEG finalizes requirements for Android devices. | N/A                                                                                                                                  |
    |----------------------------------+----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------|

  |-------------------------+----------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------|
  | Project Track           | Status                     | Comments                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Path to Green/Reason for Status Change                                             |
  |-------------------------+----------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------|
  | IR0411 VoWiFi - Acme    | AT RISK- OVERALL/ SCHEDULE | A solution to support MMS (multi-media messaging service) and VVM (visual voicemail) has been developed. Device logs for carrier bundle testing for MMS/VVM test cases are scheduled to be delivered to Acme by 10/31. 911 related changes have been deployed to production but E2E wifi 911 call is failing. DEG device logs are awaiting this call to pass. Watch item: Support for 711 location based dialing - TAS does not currently support location based services for wifi calling, and the proposal to default 711 calls to 1 of 4 regional 711 call centers was not approved by Regulatory, as a state-wide location based solution is required. Engineering developing a solution to support. | End-to-end wifi 911 call is tested by 10/25 for submission of device logs to Acme. |
  | IR0411 VoWiFi - Android | ON TRACK                   | IS/Provisioning: Targeting PI33 with December code drop and January 2020 release. IA for CR 937 approved on 9/26;   awaiting delivery of E3 from Amdocs (CR 937 adds prepaid Android development to postpaid Android development). Engineering: Tracking to December 2019 lab testing, 03/04/20 production ready, and 03/31/20 NRD. Commercial launch date for Samsung (single device) tentatively set at 05/01/20 due to 4 weeks of testing post-NRD. Other OEM's remain TBD until DEG finalizes requirements for Android devices.                                                                                                                                                                      | N/A                                                                                |
  |-------------------------+----------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------|
  ...
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | IR0411 TOPs IA -Track 1.2b (Android)                                                                                                                                                        | Target - PI 33 2nd drop - January Release                                                                                                                               |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Submit Request to reverse CR 849 changes                                                                                                                                                    |  Identify "need" date for submission - reversing CR 849                                                                                                                 |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Track 1.2 IDD (Android) update                                                                                                                                                              | "10/21 -  Frank will review and provide update by EOD. Done                                                                                                             |                                                     |
  |                                                                                                                                                                                             | 10/14 - Awaiting Amdocs update; delay due to holidays.                                                                                                                  |                                                     |
  |                                                                                                                                                                                             | 10/2 - Amdocs is checking on this                                                                                                                                       |                                                     |
  |                                                                                                                                                                                             | OFR 9/24; re-issued 9/26; commenting complete; couple of outstanding comments"                                                                                          |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | CR 937 - drafted to combine prepaid Android VoWiFi functionality with IR0411 VoWiFi postpaid Android.  It was held up for additional discussion regarding Refresh functionality for VoWiFi. | "10/14 - ETQA assessment was provided; awaiting E3                                                                                                                      |                                                     |
  |                                                                                                                                                                                             | 9/30: OFR 9/20; approved 9/26. Expecting E3 EOW; need to check on CR 937 IA / estimate from other IS team members. Update – E3 received 10/22.                          |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | "Documentation CRs                                                                                                                                                                          |                                                                                                                                                                         |                                                     |
  | 1089 - approved                                                                                                                                                                             |                                                                                                                                                                         |                                                     |
  | 1118 - OFR"                                                                                                                                                                                 | "10/14: Additional clarification requested for IR0411; will provide. Update: Provided & CR 1118 was approved.                                                           |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  |                                                                                                                                                                                             | Check the defect on 1118 & provide clarification on what is being asked.                                                                                                |                                                     |
  |                                                                                                                                                                                             | 10/21: CR 1118 approved; awaiting documentation approval SA. Update – complete."                                                                                        |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | PI Planning complete                                                                                                                                                                        | "PI33 - Scoping Meeting  October 18th. Update - IR0411 Track 1.2b was accepted into the PI 33 Release Scope.                                                            |                                                     |
  |                                                                                                                                                                                             | Watch Point                                                                                                                                                             |                                                     |
  |                                                                                                                                                                                             | Engineering  - lab readiness / MDM on-target (12/8)                                                                                                                     |                                                     |
  |                                                                                                                                                                                             | NIT testing – happens in 1st  development  drop PI32; Amdocs asked for meeting last week of October – Rachelle to  schedule.                                            |                                                     |
  |                                                                                                                                                                                             | CR 937 - approved / conditionally "                                                                                                                                     |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Code Delivery Tasks                                                                                                                                                                         | Updates or targets                                                                                                                                                      |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | TOPS Code Drop (Could be multiple drops)                                                                                                                                                    |                                                                                                                                                                         |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | TOPs Track 1.2b Postpaid Android                                                                                                                                                            | Target PI 33 (12/8/19)                                                                                                                                                  |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | CR 937 - Adding VoWiFi Prepaid Android                                                                                                                                                      | PI 33 scoping meeting is 10/18. Completed.                                                                                                                              |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | EPC Intake Request Devices - EPC                                                                                                                                                            | Need to request to reverse CR 849; need to alignment on when reversal should occur.                                                                                     |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | PDC Impacts?                                                                                                                                                                                | No impacts                                                                                                                                                              |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | EDW Impacts?                                                                                                                                                                                | No Impacts                                                                                                                                                              |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Release Assembly                                                                                                                                                                            | Updates or targets                                                                                                                                                      |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Test Prep and Execution per track                                                                                                                                                           |                                                                                                                                                                         |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Engineering Integration                                                                                                                                                                     |                                                                                                                                                                         |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Engineering Testing / w Test Devices                                                                                                                                                        |                                                                                                                                                                         |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | EPC Intake Request-Complete form (DEG Marketing )                                                                                                                                           | "9/11 - DEG team  update - new Apple devices were submitted as 'VoWiFi Capable = No'.  Tameisha will coordinate with Bill L. when these changes he needs these changes. |                                                     |
  |                                                                                                                                                                                             | 10/14 - Tameisha is target EPC MR 11/21 "                                                                                                                               |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | USC IS Support Readiness                                                                                                                                                                    | "Meeting scheduled with Chris F.; this week.  Update:  DM & SA met with Chris on 8/21.                                                                                  |                                                     |
  |                                                                                                                                                                                             | Need to complete by CI. Link to draft:                                                                                                                                  |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | ACME Post Release Activities:                                                                                                                                                               |                                                                                                                                                                         |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | "IM needs to connect to ODS ENV with  WiFi Subscriber Type info and Env with usage call type                                                                                                |                                                                                                                                                                         |                                                     |
  |                                                                                                                                                                                             | "9/23 ACME - Dave G. - will submit usage event calls he would like see - he would like to see longer calls show up in PROD ODS. Mike Schwarz agreed to make the call.   |                                                     |
  |                                                                                                                                                                                             | EDW is targeting  EDW Track 3 - (Dec. 6th for this work). IR0636 - EDW is handling VoWiFi EDW Track 3                                                                   |                                                     |
  |                                                                                                                                                                                             | Add Dave B. to email with usage event types & session info so he can search Call Dump.                                                                                  |                                                     |
  |                                                                                                                                                                                             | 10/14 - Pardeep believes Amdocs has all the information they need; will get back to Dave today.                                                                         |                                                     |
  |                                                                                                                                                                                             | 10/21 - IM/EDW has information needed for testing; looking to get UAT started Wednesday; Dave will confirm"                                                             |                                                     |
  | Call Dump Verification (downstream BAU activity)                                                                                                                                            | 9/10 - Add Dave  B. to email w/ Dave G. when we received the specific call event  session information.                                                                  |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | CR Closures                                                                                                                                                                                 | "CR 849  - Eric & Rachelle will review for closure right after this meeting. CR 849 was marked completed.                                                               |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | FraudX                                                                                                                                                                                      | "9/16 - Eric sent the User Story to Eugene B. for verification however Engineering does not believe we have impacts.                                                    |                                                     |
  |                                                                                                                                                                                             | 9/23 - Per Eugene - user story still works and we anticipate minimal to no impact on current fraud management system feeds."                                            |                                                     |
  |                                                                                                                                                                                             | MOA                                                                                                                                                                     | "Enterprise inquiry - can we push our MOA to March? |
  |                                                                                                                                                                                             | Instead of starting MOAs for our project Jan/Feb- can we wait for an enhancement  (IR6xxx) in VoLTE Wave 4?                                                             |                                                     |
  |                                                                                                                                                                                             | Commercial footprint for ACME - ~ 2 Mil                                                                                                                                 |                                                     |
  |                                                                                                                                                                                             | Per John/IS Operations throughput - roughly 12k per day in production; so total ~ 6 months                                                                              |                                                     |
  |                                                                                                                                                                                             | Also ACME takes much longer due to the process they want us to follow for devices updates.                                                                              |                                                     |
  |                                                                                                                                                                                             | Other projects underway VoLTE - Wave 3 - John Javers - will forward the chart on MOA plans. Done.                                                                       |                                                     |
  |                                                                                                                                                                                             | 10/14 - HL strategy planned; VoWiFi project team to provide list on who is needed first; and wait for remaining.                                                        |                                                     |
  |                                                                                                                                                                                             | 10/21 - VoLTE Wave 3 is done; & John will forward launch dates for Wave 4 (targeting new year). Done."                                                                  |                                                     |
  |---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------|
  | Delivery Planning Retrospective                                                                                                                                                             | "Rachelle to schedule Retrospective;  looking to schedule week of 10/7.                                                                                                 |                                                     |
  |                                                                                                                                                                                             | 10/14 Update: scheduled - Wednesday 10/23. "                                                                                                                            |                                                     |

    |--------------------------------------------------------------------------------------------------------|
    | 10/28 - UAT going fine ; minor clarification no defects Sands is participating in UAT already in loop  |
    |--------------------------------------------------------------------------------------------------------|
    | 10/14 - Pardeep believes Amdocs has all the information they need; will get back to Dave today.        |
    | Add Dave B. to email with usage event types & session info so he can search Call Dump.                 |
    |--------------------------------------------------------------------------------------------------------|
    | EDW is targeting EDW Track 3 - (Dec. 6th for this work). IR0636 - EDW is handling VoWiFi EDW Track 3   |
    | Call Dump Verification (downstream BAU activity) 10/28 - check to see if Dave B has enough info        |
    |--------------------------------------------------------------------------------------------------------|
    | Commercial footprint for ACME - ~ 2 Mil                                                                |
    |--------------------------------------------------------------------------------------------------------|
    | Per John/IS Operations throughput - roughly 12k per day in production; so total ~ 6 months             |
    ...
    |--------------------------------------------------------------------------------------------------------|
    | 10/21 - VoLTE Wave 3 is done; John will forward launch dates for Wave 4 (targeting new year) - Done.   |
    | 10/28 - send updated excel to with summary of the feedback - Done.                                     |
    |--------------------------------------------------------------------------------------------------------|
    ...
    | Project Track                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Status                                                                                                                                                                                                                                                                                                             | Comments                                                                                                                                                                                                                                                                        | Path to Green/Reason for Status Change |
    |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------|
    | IR0411 VoWiFi - Acme                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | OFF TRACK - OVERALL/ SCHEDULE                                                                                                                                                                                                                                                                                      | Acme has agreed to include voice over WiFi in the December CB, but is now requiring that the launch include all customers in the VoLTE markets (not just business customers).                                                                                                   |                                        |
    | Engineering validated a short term solution for 711 in the lab and regulatory has approved this solution for the controlled and commercial launch. This solution requires two maintenance windows and will have to fit in the existing maintenance windows for the handover/AAA deployment. Resolution of handover and AAA redundancy requires updates to all 25 LCC SAEGW. Engineering is prioritizing LCC’s that serve business critical customers to be ready in time for 12/16 controlled launch. | Engineering implements the technical solution to address 711 location-based dialing and VoLTE/VoWiFi handover in the existing maintenance windows prior to 12/16 controlled launch. Additionally, IS develops a plan to MOA all customers following the December CB to meet Acme's latest requirements for launch. |                                                                                                                                                                                                                                                                                 |                                        |
    | IR0411 VoWiFi - Android                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ON TRACK                                                                                                                                                                                                                                                                                                           | IS/Provisioning: PI33 confirmed (December code drop + January 2020 release). Engineering: 12/09/19 lab testing, 03/04/20 production ready, and 03/31/20 NRD. Commercial launch date for Samsung (single device) tentatively set at 05/01/20 due to 4 weeks of testing post-NRD. | N/A                                    |
    |-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------|

    | IR0411 TOPs IA -Track 1.2b (Android)                                                                                                                                                        | Target - PI 33 2nd drop - January Release                                                                                                                            |
    | Submit Request to reverse CR 849 changes                                                                                                                                                    | Changes being deployed with MR12.0 on 12/5                                                                                                                           |
    |                                                                                                                                                                                             | What do we want done for the January release? Since commercialization moved to February - Need confirmation for default to ON for enabled for VoWifi - let Bill know |
    | CR 937 - drafted to combine prepaid Android VoWiFi functionality with IR0411 VoWiFi postpaid Android.  It was held up for additional discussion regarding Refresh functionality for VoWiFi. | 11/4 - submit for approval. Update - approval pending                                                                                                                |
    |                                                                                                                                                                                             |                                                                                                                                                                      |
    | Documentation CRs                                                                                                                                                                           |                                                                                                                                                                      |
    | 1089 - approved                                                                                                                                                                             |                                                                                                                                                                      |
    | 1118 - OFR                                                                                                                                                                                  | 12/2 - Nick to follow up with Rachelle                                                                                                                               |
    | TOPS Code Drop (Could be multiple drops)                                                                                                                                                    | Code coming on 12/8 - confirm environment with Brian                                                                                                                 |
    | CR 937 - Adding VoWiFi Prepaid Android                                                                                                                                                      | PI 33 scoping meeting is 10/18. Completed;                                                                                                                           |
    | EPC Intake Request Devices - EPC                                                                                                                                                            | 10-28: Dependent CB December - looking to plan a date as close to January Release as possible.                                                                       |
    |                                                                                                                                                                                             | Need to request to reverse CR 849; need to alignment on when reversal should occur. Note – this will be a EPC intake request.                                        |
    |                                                                                                                                                                                             |                                                                                                                                                                      |
    | PDC Impacts                                                                                                                                                                                 | IDD approval                                                                                                                                                         |
    | Engineering Testing / w Test Devices                                                                                                                                                        | Follow up with Jim Nowakowski and Mike Schwarz                                                                                                                       |
    | USC IS Support Readiness                                                                                                                                                                    | 11/4 - still need to forward link to IS team for input. Update - sent                                                                                                |
    | Test Plan                                                                                                                                                                                   | 11/4 - Need target date for test plan update; will check with ETQA.                                                                                                  |
    |                                                                                                                                                                                             | Need an updated test plan (and test data - what does ETQA need from EPC, need to submit early to avoid delays) - follow up with Brian and Rohit                      |
    | Test Execution Cycle                                                                                                                                                                        | Tentative start - week of 12/9 dependent on environment upgrades                                                                                                     |
    | Call Dump Verification (downstream BAU activity)                                                                                                                                            | 11/4 - Dave  B. - will verify what he sees for VoWiFi. Dave will send to Nick                                                                                        |
    | MOA                                                                                                                                                                                         | 	 Enterprise inquiry - can we push our MOA to March? When are we doing the MOA? Nick to check with John Javers/Chris Baynes                                   |
*** Current Status    
    |-------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------|
    | Project Track           | Status                      | Comments                                                                                                                                                                                                                                                            | Path to Green/Reason for Status Change                                                |
    |-------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------|
    | IR0411 VoWiFi - Acme    | ON TRACK - OVERALL          | Acme pushed USCC to the February Carrier Bundle. Project team aligned on new dates/requirements to support schedule change. Training and communications plan will start on 01/20/20. IS and Engineering finalized plan to meet Acme requirements for February CB.   | Project team has re-planned to meet the requirements for the February Carrier Bundle. |
    | IR0411 VoWiFi - Android | AT RISK - OVERALL/ SCHEDULE | Lab testing delayed due to the lab MDM being down this week (testing to start on 12/13). Tracking to 03/04/20 production ready and 03/31/20 NRD. Commercial launch date for Samsung (single device) tentatively set at 05/01/20 due to 4 weeks of testing post-NRD. | N/A                                                                                   |
    |-------------------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------|
...
*** Status
    ...
    a.	Ongoing Activities
        - Capacity analysis results receives – no further action required (Bill)
        ...
        - TNS confirmed business 45 days after order submission on 8/7 (for awareness: 10/10 would be Day 45)
          - Meeting with TNS 8/20 – targeting 9/27 for capacity links in place and tested (Sherri Jo)
    ...
    b. Inbound (AT&T on USCC network)
       ...
       - TAC exceptions for Ericsson – date for the fix for the remaining MMEs to put TACs in place for AT&T on our network TBD (Bill)
       ...
       - DEG – Ryan was working on devices to ship to Teleworld (shipped half on 8/14 to be there by 8/15)
       - OEM
         - Motorola had all devices up to start testing
         - Drive test routes for Google – sent coverage information from AT&T’s map so they could find an area to test VoLTE roaming to VoLTE home (awaiting feedback from Google to see if was useful or if they prefer drive test route information) (Dan)
         - Google targeting 9/6 to complete testing (Dan)
       - Teleworld
         - ETQA inbound testing – will need to work with Accounting to determine way forward (targeting early next week for decision)
    c. Outbound (USCC on AT&T network)
       ...
       - Teleworld has two testers that are scheduled to complete testing by 9/6 (9/13 at the latest)
         ...
         - To date: one device failure (S4 mini – Ryan will need to retest)
    d. Miscellaneous
       - Continue to work on assessments for CR1020 – steering tool – before it can be submitted for approval 
    a. Ongoing Activities
       - Confirmed cross connection on 9/11 with traffic migration targeting 9/27 (Bill)
    b. Inbound (AT&T on USCC network)
       - IREG/TADIG (Network/Billing)
         - TAC exceptions for Ericsson – final fix completed 9/10 + still moving ahead with daytime testing (Bill)
       - ETQA inbound testing – Tony received ‘No UAT approval’ on 9/11
    ...
    c. Outbound (USCC on AT&T network)
       - IREG/TADIG (Network/Billing)
       - DEG – completed testing
       - OEM
         - Google still testing (no new completion date)
           - Re-pushed PLMN 9/4 –Google did not power cycle in NJ area to accept the changes (Sherri Jo)
         - LG – testing complete
         - Samsung – testing complete
         - Motorola – testing complete
       - Teleworld – 44/49 devices (as of 9/11)
       - TAC testing – Scheduled for week of 9/16 with Aniket + AT&T resources in Rockford
       - Targeting 9/30 for OB launch
         - Planning to launch in eastern region (approx. 1/3 of US) – usage will determine where to launch next
           - Steve Zimmer getting together TAC restrictions to send to AT&T
    d. Miscellaneous
       - Assessments for CR1020 (steering tool) – waiting for engineering to confirm any impacts from the security side (Sherri Jo)
       ...
       - Remedy drop down menu to include ‘AT&T Mobility’ for roamer support (Liz)
    - Ongoing Activities
      -	Traffic migration targeting 9/27
    - Inbound (AT&T on USCC network)
      - IREG/TADIG (Network/Billing)
        - TAC exceptions for Ericsson –daytime testing (still ongoing last week)
      - ETQA inbound testing – Tony received ‘No UAT approval’ on 9/11
      - IB launch Schedule:
        - 9/20 Ashburn (Go/No-go call 9/16)
        - 10/4 Schaumburg
...
- outbound (USCC on AT&T network)
  - OEM’s
    - Google testing completion date – will be delayed for all SKU’s until 11/22 (Dan)
    - Google aware of 10/16-17 launch date (Dan)
  - OB launch date = 10/16-17
    - Eastern region (approx. 1/3 of US) – usage will determine when/where to launch next, or if a pause is required to evaluate
...
- Miscellaneous
  ...
  - Tech Support will be primary POC for customers (will follow same process already utilized for the other roaming partners) (Liz)
    ...
    | Project Track                  | Status   | Comments                                                                                                                                                                                   | Path to Green/Reason for Status Change |
    |--------------------------------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------|
    | IR0622 – AT&T Outbound Roaming | ON TRACK | Outbound launch in eastern region completed 10/17. SIM OTA campaign for eastern region is scheduled for 10/23-24 (activity will then be monitored to determine when/where to launch next). | N/A                                    |
    |--------------------------------+----------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------|
    ...
    - Outbound (USCC on AT&T network)
      - OEM’s
        - Google testing will be delayed for all SKU’s until 11/22
      ...
      - Phase 2 of Launch – are we prepared to proceed and/or when would this happen?
...
** TODO [[https://usc.intranet.teldta.com/sites/EPR/IR0630/_layouts/15/start.aspx#/SitePages/Home.aspx][IR0630 - Robocall]]
*** Project Manager   
    Frank Novak
*** Go Live Date
    Feb 2020
...
** TODO IR06406 Real Time Text (RTT)
*** Project Manager
    Sheri Cass
*** Go Live Date
    N/A
