...
** On Call Documentation
   [[file:docs/ON%20CALL%20TASKS.docx][On Call Documentation]]
#+BEGIN_LaTeX
\newpage
#+END_LaTeX
* Usage Overview
...
** TODO IR0600 - 5G Commercialization
   Possible deployment date around the july 2019 timeframe, depending on the how the network upgrade
   goes (/See PCRF Forklift/).
   [[file:docs/5G%20NSA%20TOPS%20ADD%20wDel%20Plan.pdf][5G Archecture]]
...
*** Possible Billing Impact
    ...
    - *WeDo reporting :* An attempt will be made to minimize impact to WeDo Rev Assurance tool
...
** TODO Verizon LTE/VoLTE Outbound roaming
   *Deployment Date March 31st 2019.*
   - Had issues with e911 and testing is still taking place with the expected end time being January 19th. This has now been fixed but root cause unknown.
   - Scheduled:  1/21 – 1/22 Complete testing
   - Scheduled:  1/23 – 1/25 USCC/VZW perform analysis on results for a 1/25 approval
   - Scheduled:  1/28 – Planning process/steps to obtain remaining MME’s & RCC’s completed
   [[file:docs/Sprint%20WDR%20TDS%20(Special%20Select)%202018.12.21.pdf][Latest Doc]]
*** Possible Billing Issues
    - For any Ciber, Billing issues, Voice and Data Settlements, as well as
    Non-net Settlement Payment Questions or Overcharges contact:
      *RoamingSettlementsSprint@sprint.com*
...
** TODO eSIM
   SCHEDULED: <2019-01-03 Thu>--<2019-01-31 Thu> 
   ...
   Device Marketing is forcasting that all devices (handsets, tablets, wearables, etc.) will only support eSIM.
...
** TODO Voice over WIFI
   SCHEDULED: <2018-12-14 Fri>--<2019-06-22 Sat> 
...
*** Added Updates
    - Read and approved USCC TOPS IA IR0411 VoWiFi Track 1.1
    - Project is now in RED do to engineering resource contraint.

** HOLD IME Upgrade
   SCHEDULED: <2019-03-01 Fri>--<2019-03-31 Sun>
** TODO Sunset Consolidated Billing [66%]
   SCHEDULED: <2018-12-14 Fri>--<2019-02-01 Fri>
   1. [X] See who is still on TDS
   2. [X] Get contact information (See Dan's spreadsheet)
   3. [ ] Operational procedures for cutover
...
** TODO PCRF Forklift
   ...
   *Charging Enforcement Function (PCEF)* and *Online Charging System (OCS)* 
   ...
   SCHEDULED: <2019-01-08 Tue>--<2019-07-01 Mon>
...
*** Cutover will start SCHEDULED: <2019-05-01 Wed>
    It will start with LTE then move to VoLTE

*** Need to monitor the Traffic when the switchover occurs.
