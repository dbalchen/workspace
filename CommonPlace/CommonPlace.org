...
*** Go Live Dates
    Depending on how the network upgrade goes (/See PCRF Forklift/), roll out should start around *October 2019*
...
*** Current Status
    Working on User stories which at this point is mostly about provisioning.
...
*** Current Status
    Having issues with e911. If not resolved this week the project may be put on hold.
...
*** Current status
    All IA's should be complete by end of April.
    Track 1.1 complete except for provisioning
    - We now have the go ahead for Acme provisioning.
...
** Come up with GitHUB document for Collabortive Process
* Misc								   :noexport:
