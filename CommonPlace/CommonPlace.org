...
** Create Wallets 						   :noexport:
   cat .ts : Service Account SVC_NP_BILLINGOPS  Ad9PbpIe2Bc^WfKq2xntIpar
...
*** Go Live Dates
    Depending on how the network upgrade goes (/See PCRF Forklift/), roll out should start around *July 2019*
...
*** Monitors/Controls/Alerts and Ownership
    We already monitor usage by type and this would be another type.
...
*** Current Status
    1. API enhancements:
     ...
     - Amdocs work will mostly be Compilation change with proper assessment and recoding of API.
    2. Policy Controls:
...
* IDP
  - Learn EGAR
    ...
    - Credit Decisioning
  - Learn Python
    - Use python were appropriate 
  - Create some more monitors and add them to the EPS monitors
  - Learn GITHUB
    Though I'm pretty well versed with GIT, I need to better learn GITHUB especially its collaboration functions.
