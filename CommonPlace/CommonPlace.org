...
*** Event Servers
    *Turbo-Charging* is not one application but multipleinstances of *Event Servers*. Each event server corresponds to a bill cycle. Their status can be viewed using
...
#+END_LaTeX
      ...
      - *Batch4* -- *kprl6batch.uscc.com (10.176.181.123)*
       Must sign in as prdwrk6 using the super *secret* password
	: /pkgbl06/inf/aimsys/prdwrk6/eps/monitors
      ...
      - *EBI* - *kpr01ebiap.uscc.com (10.176.177.211)*
	: /home/common/eps/monitors
	/Before restarting remove all err and log files./
#+BEGIN_LaTeX
\normalsize
#+END_LaTeX
** Overage Protection
...
graph [splines=true nodesep=0.8 overlap=false style=bold];
"kpr02batch\nSwitch\nDirectories" -> "EBI\nOperational\nServer"  [label = "(a)"];
"kpr01batch\nLog\nDirectories" -> "EBI\nOperational\nServer" [label = "(b)"];
node [shape=folder];"ODS Prod";"BRM Prod";
"ODS Prod" -> "EBI\nOperational\nServer" [label = "(c)"];
"BRM Prod" -> "EBI\nOperational\nServer"[label = "(d)"];
}
...
** HOLD Open RC for RoamRecon USID and password.
   SCHEDULED: <2018-03-19 Mon>
** TODO Investigate the discrepencies in the Roamining Recon Report
...
*** TODO Investigate record count varience in LTE and CDMA
*** TODO LTE/CDMA Outcollects move back 3 days			    :ARCHIVE:
    DEADLINE: <2018-04-17 Tue>
*** TODO Logical flow for all usage types
...
** TODO Volte Roaming
*** Verizon  California, Washington, Oregon,  TMO West Virginia, Maine, & Nebraska
     DEADLINE: <2018-04-30 Mon>
*** Verizon Remaining Verizon Markets
      DEADLINE: <2018-07-31 Tue>
*** TMO Remaining TMO Markets
    DEADLINE: <2018-09-28 Fri>     
** TODO Finish Christine's Data Outcollect Issue
   SCHEDULED: <2018-04-02 Mon>
   - [ ] Check out that SID 
   
** TODO Project Sentinel  
   A database used in the MFT transfer. Only used by the job below. 
   : [‎3/‎19/‎2018 11:37 AM] Lee, Daniel W: 
