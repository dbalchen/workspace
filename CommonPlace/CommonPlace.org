...
*** Go Live Dates
    ...
    - Track1 – TOPS Provisioning changes (Amdocs) – 1 PI effort – 1 User story
      - Deployment Phase Complete - 11/3/2019
    - Track2 – TOPS Charging changes (PDC) – TBD – dependency on data refinery – target Oct, 2019
      -  Deployment Phase Complete - 1/25/2020
    ...
    - Expect to be finished early 2020
*** Open Issues
...
*** Project Manager
    Bengtson, Kevin
*** Description
    This project is to enable Google Fi customers access to the VoLTE network and Enhanced Calling Services.
*** Status
    Held first meeting on October 17th
