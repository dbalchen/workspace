...
** Production Servers/EpsMonitors
 ...
 mkstore -wrl <wallet_location> -createCredentialdf <db_connect_string> <username> <password>

 mkstore -wrl . -deleteCredential bods_svc_billingops svc_np_billingops
 mkstore -wrl . -modifyCredential cst_svc_billingops svc_np_billingops
...
#+END_LaTeX
*** TSP Tops Servers
    - *prodtc1-6* For all production service accounts.
...
** EBI Operational Server
*** Development Server Logins
#+BEGIN_LaTeX
\footnotesize
#+END_LaTeX
#+ATTR_LaTeX: :environment longtable :align l|l
...
** TODO Finish bogusDoc.pl
   Add Ban Information
   DEADLINE: <2018-08-17 Fri>
** TODO PGW Upgrade
...
*** TODO Push Applications to TSP Production/OPER [60%]
    - [ ] Push out the monitors
    - [X] m2mList.pl
    - [ ] runRecon.pl
    - [X] AR9RPLDAILY.pl
    - [X] ip_check_monitor.pl
    SCHEDULED: <2018-08-02 Thu>--<2018-08-31 Fri>
*** DONE MFT file transfers					    :ARCHIVE:
...
*** TODO Database access for Production ODS			    :ARCHIVE:
    SCHEDULED: <2018-08-02 Thu>--<2018-08-31 Fri>
*** TODO Firewall access DataBase and CallDump
    SCHEDULED: <2018-08-02 Thu>--<2018-08-31 Fri>
** Arabic Scales
*** Major
    : C, D, E, F, F#, G#, Bb, C
