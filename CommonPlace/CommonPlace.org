...
** TODO [[https://usc.intranet.teldta.com/sites/EPR/IR0583/_layouts/15/start.aspx#/SitePages/Home.aspx][IR0583 eSIM for Standalone devices]]
*** Project Manager
    Sara Singh
*** Project Description
   ...
   provisioning and assignment of the “One Number” feature so that the secondary device and the primary device
...
*** Status 
    ...
    *UAT in Progress*
    - A IR0583 – eSIM Consumer Enable-meant Track 2 - Secondary Device Activation Impact Assessment (IA) is waiting approval (Still Waiting).
