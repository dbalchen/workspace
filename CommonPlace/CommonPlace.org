...
*** Current Status
    ...
    - Mr. Hauk has sent out the various proposels on the 5G usage which includes:
      ...
      - *5G Usage in 5G-NR Record Type* Where 2 records are produced 1 for 4G and 1 fro 5G.
...
*** Current Status 
    ...
    *UAT in Progress*
    - A IR0583 – eSIM Consumer Enablement Track 2 - Secondary Device Activation Impact Assessment (IA) is waiting approval.
...
*** Current Status
    We are working thru the logistics now and we will identify who will need to attend the testing as required or on call.  More to come…
...
** TODO Setup CallDump Server [57%]
   - [ ] Setup Wallets
   - [X] Finish Server Doc
   - [ ] Open ports request [0%]
     - [ ] Waiting for ports to be open.
   - [X] recompile applications
   - [ ] copy files
   - [-] Setup Tomcat [50%]
     - [X] Check Database Connection
     - [ ] Get CallDump working (try using old tomcat_prod)
   - [X] What about WEDO?
   - [X] Check Perl/Python
* Misc								   :noexport:
