...
* Task List							   :noexport:
** TODO IR0600 - 5G Commercialization
...
*** Current Status
    At this point the big issue is that we can't distinquesh between 4 and 5G. So until that is fixed 5G will come in as 4G. Another issue is the switchwing between the feeds 
    which could create thousands of records per session. The current plan is to combine these records before being sent to TOPS.
    

** TODO Verizon LTE/VoLTE Outbound roaming
...
** TODO International Service Revamp
...
*** Go Live Dates
    Phase 1 targeting June release.
*** Possible Billing Issues
...
** TODO eSIM for Standalone devices
*** Project Manager
    Sara Singh
*** Project Description
...
** TODO Sunset Consolidated Billing [80%]
...
** TODO PCRF Forklift
   DEADLINE: <2019-05-01 Wed>--<2019-06-30 Sun>
...
**** Go Live March 7th
**** Archetecture
**** TODO What machine does the OSB reside??? 
**** TODO Is Splunk the only way to read the logs
**** TODO Where are the reports kept
**** TODO Find those OSB Query's
***** Connection String
...
**** TODO Log into the Tops Databases.
***** TABLE_CCLASS_IN
     ...
     |-------------------------+--------------------+---------------|
** TODO Usage Playbook
   SCHEDULED: <2019-03-25 Mon>--<2019-12-31 Tue>
...
** TODO Come up with GitHUB document for Collabortive Process
* Misc								   :noexport:
