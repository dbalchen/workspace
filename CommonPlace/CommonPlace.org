...
*** Current Status
    NDC will be rolling out a new version of there mediation software which will help with some of the issues with being able
    to distinguish between 5G and 4G.
...
** TODO [[https://usc.intranet.teldta.com/sites/EPR/IR0596/_layouts/15/start.aspx#/SitePages/Home.aspx][IR0596 International Service Revamp]]
   DEADLINE: <2019-06-01 Sat>--<2019-06-30 Sun>  
*** Project Manager
    Rebecca Class
*** Project Description
...
** TODO [[https://usc.intranet.teldta.com/sites/EPR/IR0539/_layouts/15/start.aspx#/SitePages/Home.aspx][VoLTE Prepaid]]
*** Project Manager
    Rachelle Funderburg 
*** Project Description
...
** TODO [[https://usc.intranet.teldta.com/sites/EPR/IR0622/_layouts/15/start.aspx#/SitePages/Home.aspx][IR0622 AT&T Inbound and Outbound LTE/VoLTE Roaming]]  
   Initial stages: No documents or timeline but they do have a Sharepoint site now.
...
*** Project Manager
    Christopher Barton
*** Project Description
    The objective of this project is to implement WPS (Wireless  Priority Service) on USCC ‘s LTE network with a limited capability (LC) by September 13th , 2019.
*** Go Live Date
    September 13th, 2019
*** Open Issues
    None
...
***** TABLE_CCLASS_IN
     ...
     |-------------------------+--------------------+---------------|
** TODO Finish new EPS Monitors for Data 
   - [X] Write Code
   - [ ] Add to CallDump
   - [ ] refresh code in EpsMonitors/Git
   - [ ] Make changes to dash,html and dash.js (maybe)
   - [ ] Talk to Dave about triggers for Oncall
** TODO Come up with documentation standards
** TODO Knowledge Transfer for usage.pl
** TODO Setup CallDump Server [66%]
   - [X] Finish Server Doc
   - [X] Open ports request
