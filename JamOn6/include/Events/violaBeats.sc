...
~string2_firmus.filter.release = 0.6;
...
~defaultViolaB = {
    ...
    ~string2_firmusB.amp = 0.08;
    ~string2_firmusB.envelope.sustain = 0.8;
    ~string2_firmusB.envelope.release = 0.6;
