...
SynthDef(\myASR,{arg out = 0, attack = 8, sustain = 1, release = 0.2, gate = 0,aoc = 0.70, cutoff = 1, da = 2;
    var sig;
...
SynthDef(\myADSR,{arg out = 0, attack = 0, decay = 0.0, sustain = 0, release = 0.0, gate = 0,aoc = 1.0, cutoff = 1, da = 2;
    var sig;
